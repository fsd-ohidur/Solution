...
namespace Solution.Web.CNF.Controllers
{
	public class BuyerController : Controller
	{
		...
		public async Task<IActionResult> Index()
		{
			...
			var response = await _Service.Buyers.GetAllAsync(ComId, UserId, route);
		...
		public async Task<IActionResult> Details(string id)
		{
			var ComId = Request.Cookies["ComId"];
			var UserId = Request.Cookies["UserId"];
			var model = await _Service.Buyers.GetByIdAsync(id, ComId, UserId, route);
			if (model == null)
			{
				return NotFound();
			}
		...
		public async Task<IActionResult> Create(BuyerDto model)
		{
			if (ModelState.IsValid)
			{
				...
				model.ComId = ComId;
				var response = await _Service.Buyers.CreateAsync(model, ComId, UserId, route);
				if (response != null && response.IsSuccess)
				{
		...
		public async Task<IActionResult> Edit(string id)
		{
			...
			var response = await _Service.Buyers.GetByIdAsync(id, ComId, UserId, route);
			if (response != null && response.IsSuccess)
			{
		...
		public async Task<IActionResult> Edit(BuyerDto model)
		{
			if (ModelState.IsValid)
			{
				...
				model.ComId = ComId;
				var response = await _Service.Buyers.UpdateAsync(model, ComId, UserId, route);
				if (response != null && response.IsSuccess)
				{
		...
		public async Task<IActionResult> Delete(BuyerDto model)
		{
			...
			var response = await _Service.Buyers.DeleteAsync(model.Id, ComId, UserId, route);
