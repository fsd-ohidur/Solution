...
{
	public class CarryingContractor1Controller : Controller
	{
		...
		public CarryingContractor1Controller(IUnitOfService service, IHttpContextAccessor httpContextAccessor)
		{
			_Service = service;
